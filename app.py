...
# THEME
# ---------------------------------------------------
# Fraud vs. legitimate reads intuitively as crimson (danger) vs. emerald
# (safe) — a bold, single-dominant-hue identity in the same spirit as this
# portfolio's other apps, rather than the previous muted navy/slate/gold combo.
...
GOLD = "#F59E0B"
LINE = "#F3E1E5"
PALETTE = [CRIMSON, EMERALD, GOLD, SLATE_LIGHT]
...
st.markdown(
    ...
    h1, h2, h3 { color: #20141A; font-weight: 700; }
    ...
    .app-header .eyebrow {
        ...
        text-transform: uppercase; color: #FFD9E1; margin-bottom: 4px;
    }
    .app-header h1 { font-size: 26px; margin: 0; color: #FFFFFF; }
    .app-header p { font-size: 14px; color: #FFE7EC; margin: 4px 0 0; }

    [data-testid="stMetric"] {
        background: #FFFFFF; border: 1px solid #F3E1E5; border-radius: 14px;
        padding: 16px 18px; box-shadow: 0 2px 10px rgba(225,29,72,0.08);
    }
    [data-testid="stMetricLabel"] { color: #5B4B50; font-weight: 600; }
    [data-testid="stMetricValue"] { color: #9F1239; font-weight: 800; }

    .section-title {
        font-size: 12.5px; font-weight: 700; text-transform: uppercase;
        letter-spacing: 0.06em; color: #E11D48; margin: 30px 0 14px;
    }

    .chart-card {
        background: #FFFFFF; border: 1px solid #F3E1E5; border-radius: 14px;
        padding: 18px 20px 6px; box-shadow: 0 2px 10px rgba(225,29,72,0.08);
        margin-bottom: 18px;
    }
    .chart-card h4 {
        margin: 0 0 8px; font-size: 13px; font-weight: 700; color: #20141A;
    }

    .insight-card {
        background: #FFFFFF; border: 1px solid #F3E1E5; border-left: 4px solid #059669;
        border-radius: 12px; padding: 18px 22px; box-shadow: 0 2px 10px rgba(225,29,72,0.08);
    }
    .insight-card ul { margin: 0; padding-left: 18px; }
    .insight-card li { color: #5B4B50; font-size: 14px; margin-bottom: 8px; line-height: 1.5; }

    [data-testid="stDataFrame"] { border: 1px solid #F3E1E5; border-radius: 12px; }
    [data-testid="stTable"] { border: 1px solid #F3E1E5; border-radius: 12px; }
    [data-testid="stFileUploader"] {
        background: #FFFFFF; border: 1.5px dashed #E11D48; border-radius: 12px;
    }
    </style>
    """,
...
CRIMSON_CMAP = sns.light_palette(CRIMSON_DARK, as_cmap=True)
